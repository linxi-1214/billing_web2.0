            ...
            <div className="bd-example bd-example-tabs">
                <nav>
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                        {this.props.tabs.map((tab_name) => {
                            return <a className="nav-item nav-link" id={'nav-' + tab_name + '-tab'} data-toggle="tab"
                                      href={"#nav-" + tab_name} role="tab" aria-controls=""
                        })}
